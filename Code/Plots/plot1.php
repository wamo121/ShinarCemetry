...
<div class="page-header">
            <h1>Generate Plot Report: Plot 1</h1>
        </div>
<!--Section 1: Download Function-->
<!-- allow for execution of plot download-->
 <form method='post' action='DownloadPlot1.php'>
  ...
  <!-- Links to other plot tables -->
    ...
    //selects all records that are in current plot (1-4 depending on page)
      ...
      WHERE grave.PlotNum=1 ORDER BY grave.LotNum, grave.GraveNum asc";
