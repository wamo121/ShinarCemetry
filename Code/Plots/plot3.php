...
<div class="page-header">
            <h1>Generate Plot Report: Plot 3</h1>
        </div>
<!-- allow for execution of plot download-->
 <form method='post' action='DownloadPlot3.php'>
  ...
  <table class='table table-hover table-responsive table-bordered'>
    ...
    <?php 
      ...
      WHERE grave.PlotNum=3 ORDER BY grave.LotNum, grave.GraveNum asc";
